...
extracted_dir = os.getcwd() + "/seq_length_128/"
os.mkdir(extracted_dir)
extracted_train_path = extracted_dir + "extracted_train_frames/"
extracted_val_path = extracted_dir + "extracted_val_frames/"
extracted_test_path = extracted_dir + "extracted_test_frames/"
os.mkdir(extracted_train_path)
os.mkdir(extracted_val_path)
os.mkdir(extracted_test_path)

#directory to save extracted data
extracted_data_dir = extracted_dir + "extracted_data/"
